-- ============================================================
-- MEAL PLANNER - CONSOLIDATED SEED DATA
-- Gộp từ:
--   - src/main/resources/data.sql
--   - src/main/resources/mockdata_seed.sql
--   - db-data/seed_data.sql
-- File này có thể chạy độc lập sau khi đã tạo schema.
--
-- Mỗi phần insert được bọc bằng START TRANSACTION / COMMIT để xác nhận riêng.
--
...
INSERT INTO tblUserAccount (id, username, email, password_hash, role, status, created_at, updated_at) VALUES
(1, 'admin', 'admin@mealplanner.vn', '$2b$12$IuxyoK7JTDYU3E8wKRGEheTHB3k7mLdrsnLih60UqzlElXfwiXjcS', 'admin', 'active', NOW(), NOW()),
(2, 'nhan',    'an.nguyen@gmail.com',  '$2b$12$F9eVe5k.Os.0zDWWfUsLGO2HtQXFozxFl3t5oOHtS9U3xM6NRZX8i', 'user',  'active', NOW(), NOW()),
(3, 'phuoc',    'binh.tran@gmail.com',  '$2b$12$jSfYMhxrjRNqZC0N5YJ2zeOPRXMaFRlENYHmMNk/gfMLtYX.znuya', 'user',  'active', NOW(), NOW()),
(4, 'lechau',      'chau.le@yahoo.com',    '$2b$12$TaL2pEX6t3AHOMN.Y/4MqeT6O8S4abM7Xm7SSWZJ2gt8hyMf8tp2e', 'user',  'active', NOW(), NOW()),
(5, 'phamdung',    'dung.pham@outlook.com','$2b$12$huZ3QGlgIpyfPNu5H2fiaO480Onb3vnxzzpGSZU.oeGXqSeXEFUPq', 'user',  'active', NOW(), NOW()),
(6, 'hoangem',     'em.hoang@gmail.com',   '$2b$12$7uetIO0OpuVY2jb0tjdsGuO72Qb5uLWIEN9bamz7yjySe9FDT1cLu', 'user',  'locked', NOW(), NOW());
